...
<div class="container">
    ...
    <a href="/apple6a/app/views/sexo/create.php"><button>Agregar Sexo</button></a>
            ...
            <?php if (!empty($sexos) && is_array($sexos)): ?>
                <?php foreach ($sexos as $sexo): ?>
                    <tr>
                        ...
                        <td>
    <a href="/apple6a/public/sexo/edit?id=<?php echo htmlspecialchars($sexo['id']); ?>">
        <button>Editar</button>
    </a>
    <a href="/apple6a/public/sexo/eliminar?id=<?php echo htmlspecialchars($sexo['id']); ?>" 
